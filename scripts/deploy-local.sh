...
USE_K8S_POLICIES="${USE_K8S_POLICIES:-false}"
KUBERNETES_VERSION="${KUBERNETES_VERSION}"

# Export variables for child scripts
export KIND_CLUSTER KIND_MEMORY_GB PODMAN_MACHINE_NAME REGISTRY_HOST_PORT ENABLE_REGISTRY_PORT KUBERNETES_VERSION
...
USE_K8S_POLICIES="${USE_K8S_POLICIES}" \
